// src/components/InvoicePrinter.tsx
...
// Remove useEffect and make it a regular component
const InvoicePrinter: React.FC<{ invoice: InvoiceData }> = ({ invoice }) => {
